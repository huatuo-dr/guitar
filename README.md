...
《老男孩》《后来》《空心》《突然好想你》均可在完整谱与简易谱间切换。按钮位于每行小节/缩放提示下方，模式按曲目记忆。简易谱按演奏路线展开反复，双行歌词按实际演唱遍次选取，公共单行歌词复用；前奏、间奏、过门与器乐尾奏保留完整谱面。演唱段紧凑排版，句间留空，较大语义段落换行；换和弦的字加下划线，没有新歌词的位置显示 `_`。打印当前视图，下载HTML包含两个视图。
